...
def _compile_dependencies():
    ...
    custom_kernel_constraint = (
        seq_len > 16 and seq_len <= 32768 and seq_len % 4 == 0 and attn_batch_size % 4 == 0
    )
    # Print a warning.
    if not ((args.fp16 or args.bf16) and custom_kernel_constraint and args.masked_softmax_fusion):
        if args.rank == 0:
            print("=======================args.masked_softmax_fusion============",custom_kernel_constraint, args.masked_softmax_fusion)
            print(

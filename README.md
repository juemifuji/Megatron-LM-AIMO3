...
## Quick Start
To get started quickly, we strongly recommend using the NVIDIA [Docker](nvcr.io/nvidia/pytorch:25.12-py3) environment, which eliminates the need for additional software installation.
